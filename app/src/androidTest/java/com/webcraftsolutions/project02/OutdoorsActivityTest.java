...
public class OutdoorsActivityTest {
    ...
    /**
     * Implementation Test for OutdoorsActivity's intent factory method.
     */
    @Test
    public void outdoorsIntentFactory() {
        Intent intent = OutdoorsActivity.outdoorsIntentFactory(context, user.getId());
