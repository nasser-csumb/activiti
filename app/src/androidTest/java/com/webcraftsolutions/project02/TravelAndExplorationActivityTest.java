 ...
 * File: TravelAndExplorationActivityTest.java - Implementation of TravelAndExplorationActivityTest
 * @author Jian Mitchell
 * Professor: Dr. C
 * Date: 23 April 2025
 * Explanation/Abstract: This will test the TravelAndExplorationActivity.java file.
 */
...
public class TravelAndExplorationActivityTest {
    ...
    private static final String TRAVEL_EXPLORATION_EXTRA = "TRAVEL_EXPLORATION_INTENT_EXTRA";
    ...
    public void travelAndExplorationActivityIntentFactory() {
        ...
        assertFalse(intent.getBooleanExtra(TRAVEL_EXPLORATION_EXTRA, false));
    }
}
