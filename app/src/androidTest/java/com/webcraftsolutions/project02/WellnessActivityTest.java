/**
 * Title: CST-338 Project 02: Activiti - WellnessActivity Test
 * @author Nasser Akhter
 * Date Created: 4/22/2025
 * Description: Unit test for WellnessActivity's intent factory method.
 */
...
public class WellnessActivityTest {
    ...
    /**
     * Implementation Test for WellnessActivity's intent factory method.
     */
    @Test
    public void wellnessActivityIntentFactory() {
        // Get intent from factory
        Intent intent = WellnessActivity.wellnessActivityIntentFactory(context, user.getId());
